...
const u8 Joystick_ConfigDescriptor[JOYSTICK_SIZ_CONFIG_DESC] =
{
 ...
 0x80,	//bmAttributes??   0xC0,         /* bmAttributes: Self powered */
 0x32,	//bMaxPower 100ma
	/*第一个接口描述：通信接口*/
    0x09,         /* bLength: Interface Descriptor size */
    USB_INTERFACE_DESCRIPTOR_TYPE,/* bDescriptorType: Interface descriptor type */
    0x00,         /* bInterfaceNumber: 接口号，从0开始依次排号 */
    0x00,         /* bAlternateSetting: Alternate setting */
    0x02,         /* bNumEndpoints 为该接口所使用的端点数目（不包括端点0）*/
    ...
    0x22,         /* bDescriptorType */
		Custom_ReportDescriptor_Size&0xFF,		// wItemLength: Total length of Report descriptor
...
const uint8_t CustomHID_ReportDescriptor[Custom_ReportDescriptor_Size] =
  {                    
    ...
    0x09, 0x01,            /*     USAGE (comm)	             */
    0x15, 0x00,            /*     LOGICAL_MINIMUM (0)        */          
    0x25, 0xff,            /*     LOGICAL_MAXIMUM (255)        */           
    0x75, 0x08,            /*     REPORT_SIZE (8) 报告大小（即这个字段的宽度）为8bit */        
    0x95, CUSTOMHID_MSG_LENGTH, /*     REPORT_COUNT 数据长度 */       
    0xB1, 0x82,             /*    FEATURE (Data,Var,Abs,Vol) */     
    0x09, 0x01,            /*     USAGE (LED 1)              */
    0x91, 0x82,            /*     OUTPUT (Data,Var,Abs,Vol)pc到设备  */
